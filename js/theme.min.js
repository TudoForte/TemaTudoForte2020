...
if (document.body.contains (document.getElementById ('product-container'))) {
  ...
  function createGallery (array, slug, video) {
    array.forEach (item => {
      let image = `<div class="swiper-slide"><img class="galleryImage" src="${item.https}" alt="${slug}" /></div>`;
...
function openDescription(){
  ...
  let buttonPageProductDescription = document.getElementsByClassName('board_htm')[0];
...
function topFunction() {
    ...
    document.body.scrollTop = 'smooth'
}
